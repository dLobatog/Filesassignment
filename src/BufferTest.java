 ...
 *Se utiliza una memoria intermedia con política de liberación aleatoria.
 */
...
public class BufferTest {
    ...
    /**
	 * Ejemplo de uso de una memoria intermedia con política de liberación aleatoria de 'numberOfPages' páginas de tamaño 'blockSize' bytes.
	 * @param args
	 */
	public static void main(String[] args) {
            int numberOfPages=2; //Número de páginas de la memoria intermedia que se creará
            int blockSize=16; //Tamaño de las páginas de la memoria intermedia

            //Se crea una memoria intermedia de número y tamaño de páginas definido. 
            //La memoria intermedia permite trabajar con bloques de uno o más ficheros.
            //Cada página de memoria podrá alojar el contenido de alguno de los bloques de los ficheros abiertos.
		...
		String f0String0 = "f0 string 0";//Cadena de caracteres que se escribirá en el fichero f0 en el bloque 0
		String f0String1 = "f0 string 1";//Cadena de caracteres que se escribirá en el fichero f0 en el bloque 1
                String f0String2 = "f0 string 2";//Cadena de caracteres que se escribirá en el fichero f0 en el bloque 2
                
                String f1String0 = "f1 string 0";//Cadena de caracteres que se escribirá en el fichero f1 en el bloque 0
		String f1String1 = "f1 string 1";//Cadena de caracteres que se escribirá en el fichero f1 en el bloque 1
                String f1String2 = "f1 string 2";//Cadena de caracteres que se escribirá en el fichero f1 en el bloque 2
                
                byte [] bytesOfString=new byte[11]; //Array que se utilizará para recuperar en forma de bytes las cadenas de caracteres de los ficheros
		...
		try {
			...
			block.put(f0String0.getBytes());
                        ...
                        // Se adquiere el bloque 1 de f0, se lleva el puntero a la posición inicial y se escribe en él la cadena de caracteres f0String1 (1 acceso, van 2)
			...
			block.put(f0String1.getBytes());
                        ...
                        // Se adquiere el bloque 2 de f0, se lleva el puntero a la posición inicial y se escribe en él la cadena de caracteres f0String2 (1 acceso, van 3)
			...
			System.out.println(new String(bytesOfString));
                        //Se pone lleva el puntero a la posición inicial del block y se sustituye por la misma cadena en mayúsculas
                        block.clear();
			...
			f1 = buffer.openFile("testFile1.txt","rw");
                        ...
                        // Se adquiere el bloque 0 de f1, se lleva el puntero a la posición inicial y se escribe en él la cadena de caracteres f1String0 (1 acceso, como mucho van 5)
			...
			block.put(f1String0.getBytes());
                        ...
                        // Se adquiere el bloque 1 de f1, se lleva el puntero a la posición inicial y se escribe en él la cadena de caracteres f1String1 (1 acceso, como mucho van 6)
			...
			block.put(f1String1.getBytes());
                        ...
                        // Se adquiere el bloque 2 de f1, se lleva el puntero a la posición inicialy se escribe en él la cadena de caracteres f1String2 (1 acceso, como mucho van 7)
			...
			block.put(f1String2.getBytes());
                        ...
                        block = buffer.acquireBlock(f0, 0); //(1 acceso máximo si este bloque ya ha sido liberado con antelación, como mucho van 8)
                        block.clear();                        
                        block.get(bytesOfString); //Lectura de toda la cadena
                        System.out.println("\n8: Read block 0 (testFile0.txt):'"+new String(bytesOfString)+"'\n");

                        block = buffer.acquireBlock(f0, 1); //(1 acceso máximo si este bloque ya ha sido liberado con antelación, como mucho van 9)
                        block.clear();
                        ...
                        block = buffer.acquireBlock(f0, 2); //(1 acceso máximo si este bloque ya ha sido liberado con antelación, como mucho van 10)
                        block.clear();                        
                        for(int i=0;i<11;i++)
                            bytesOfString[i]=block.get(); //Lectura byte a byte
                        System.out.println("\n10 Read block 2 (testFile0.txt):'"+new String(bytesOfString)+"'\n");
                        block = buffer.acquireBlock(f1, 0); //(1 acceso máximo si este bloque ya ha sido liberado con antelación, como mucho van 11)
                        block.clear();
                        block.get(bytesOfString);
                        System.out.println("\n11 Read block 0 (testFile1.txt):'"+new String(bytesOfString)+"'\n");
                        
                        block = buffer.acquireBlock(f1, 1); //(1 acceso máximo si este bloque ya ha sido liberado con antelación, como mucho van 12)
                        block.clear();
                        ...
                        block = buffer.acquireBlock(f1, 2); //(1 acceso máximo si este bloque ya ha sido liberado con antelación, como mucho van 13)
                        block.clear();
                        for(int i=0;i<11;i++)
                            bytesOfString[i]=block.get(); //Lectura byte a byte
